...
| | |
|---|---|
| ![](screenshots/mobile.png) | ![](screenshots/mobile-2.png) |

## Settings
| Desktop | Mobile |
|---|---|
| ![](screenshots/settings.png) | ![](screenshots/mobile-settings.png) |

## Installation
- Open your **Settings**
- Under **Options** > **Appearance**...
  - If you haven't already, switch your **Base color scheme** to **Dark**
  - Click **Manage** and search for "Zenburn"
